...
class _CreateRoutePageState extends State<CreateRoutePage> {
  ...
  void getSelectedCategories() {
    selectedCategories = filterCategories.where((element) => element.isSelected).toList();
    setState(() {});
  }
                          ...
                          element: DropdownButton(
                            ...
                            items: iller.map((String items) {
                              return DropdownMenuItem(
                                  value: items, child: Text(items, style: context.textTheme.headline6!.copyWith(color: Colors.indigo, fontSize: 18)));
                            }).toList(),
                            style: context.textTheme.headline6!.copyWith(color: Colors.indigo, fontSize: 18),
                            onChanged: (newValue) {
                              setState(() {
